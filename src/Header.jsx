    ...
    return (
        ...
        <div className="flex flex-row items-center justify-between px-6 md:flex-row">
            ...
            <div className="flex items-center space-x-4">
                ...
                {/* Search Icon */}
                    {
                    !location.pathname.includes("shop")? null : <svg onClick={()=> setShowSearch(true)} className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
                ...
                <div className="relative">
                    ...
                    <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]">{cartSize}</p>
                </div>
                {/* User Icon */}
                <div className="group relative">
                    
                        <svg onClick={()=> token ? null : navigate('/login')} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
